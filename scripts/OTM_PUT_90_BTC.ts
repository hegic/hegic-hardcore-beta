...
async function main() {
  ...
  const { alice, deployer, hegicOtmPutBTC, WBTC, USDC, OtmPriceCalculator_BTC, btcPriceFeed } = contracts
  ...
  console.log("BTC-PUT-90 Total Cost (USD)", ethers.utils.formatUnits(alice_spent, await USDC.decimals()))
  console.log("BTC-PUT-90 completed.")
